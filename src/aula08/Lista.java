...
public class Lista {
    ...
    private static int[] v; //Vetor usado para ordenações
    ...
    //Metodo de SELEÇÃO
    public static void sortSelecao(int numElementos) {
        int menor, auxiliar;
    ...
    //Metodo de INSERÇÃO
    public static void sortInsercao(int numElementos) {
        int auxiliar;
    ...
    public static void insereEOrdena(int[] novosValores) {
        for (int i = 0; i < novosValores.length; i++) {
            inserir(novosValores[i]);
        }

        sortSelecao(novosValores.length);
    }
